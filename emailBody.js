const emailBody = (resetId, username) => {
    return `
...
<!--<![endif]-->
    <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #fff;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
      ...
      <div style="background-color: #4b5462;background: 0px 0px/auto auto repeat url(https://i1.createsend1.com/ei/t/26/540/5A1/055146/csfinal/beer-1074950_1280.jpg) #4b5462;background-position: 0px 0px;background-image: url(https://i1.createsend1.com/ei/t/26/540/5A1/055146/csfinal/beer-1074950_1280.jpg);background-repeat: repeat;background-size: auto auto;">
        <div class="layout one-col stack" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
          <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;">
      ...
      <div style="mso-line-height-rule: exactly;line-height: 50px;font-size: 1px;">&nbsp;</div>
            ...
            <div style="Margin-left: 20px;Margin-right: 20px;">
      <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
        <h2 class="size-16" style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #e31212;font-size: 16px;line-height: 24px;font-family: Avenir,sans-serif;text-align: center;" lang="x-size-16"><strong>If you do not request an email reset, please ignore this email</strong></h2>
      </div>
    </div>
            ...
            <div class="column wide" style="text-align: left;font-size: 12px;line-height: 19px;color: #adb3b9;font-family: sans-serif;Float: left;max-width: 400px;min-width: 320px; width: 320px;width: calc(8000% - 47600px);">
              <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
                ...
                <div style="font-size: 12px;line-height: 19px;">
                  <div>BeerBookmark<br />
beerbookmark.com</div>
                </div>
                <div style="font-size: 12px;line-height: 19px;Margin-top: 18px;">
                  <div>You are receiving this email because you are subscribed to BeerBookmark</div>
                </div>
                <!--[if mso]>&nbsp;<![endif]-->
              </div>
            </div>
